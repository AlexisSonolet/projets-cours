...
- \frac{ \left( y - \frac{\theta}{4} \right) ^2 }{2 (\sqrt 2) ^2}
\right) \$ suit une loi normale \$ N \left( \frac{\theta}{4}, \sqrt 2
\right) \$. La partie en \$ exp \left( -
\frac{ \theta ^2 }{2 (4\sqrt 2) ^2} \right) \$ suit une loi normale \$ N
\left( 0, 4 \sqrt 2 \right) \$.
